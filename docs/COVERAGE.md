...
At the last full sweep: **705 pass, 55 disagree, 37 cannot be measured.**

## The 37 that cannot be measured

36 of the 37 are fixtures with nothing to check against. One is a real gap in
coreval, and is marked as such rather than folded in with the rest.
