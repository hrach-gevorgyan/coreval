...
Look at row 2: `2024-02-30`. February never has 30 days. Did it notice?

```{r one-dataset-date}
result$findings[result$findings$Value == "2024-02-30", ]
```

Yes — row 2, `AESTDTC`, flagged by `CORE-000547`, the rule that says date
variables have to hold real dates.
